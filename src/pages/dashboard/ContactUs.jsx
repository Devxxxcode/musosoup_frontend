        ...
        <div className="flex flex-col items-center justify-center mt-10 md:2 mb-52 text-gray-800">
            ...
            <div className="text-center mb-10">
                <div className="flex flex-col items-center">
                    <img src={logo} alt="Musosoup Logo" className="w-48 h-auto mb-4" />                    <FaHeadset className="text-6xl text-gray-300 mb-4" />
                </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md w-80 text-center">
                ...
                <div className="space-y-4">
                    ...
                    <button
                        ...
                        className="w-full bg-primary text-white py-2 rounded-full flex items-center justify-center gap-2 hover:bg-primary transition duration-200"
                    >
                        <FaCommentDots />
                        Online Chat
                    </button>
